        ...
        <table class="table table-bordered table-striped">
            ...
            <?php foreach($list as $l):?>
                <tr>
                    ...
                    <td>
                        <?php if($l->status==1):?>
                        <?=Html::a('相关业态设置','script:void(0)',['data-id'=>$l->id,'data-toggle'=>"modal",'data-target'=>"#editRelationModal",'class'=>'btn btn-xs btn-warning'])?>
...
<div id="editRelationContent">
    <form class="form-horizontal" role="form">
        ...
        <div class="form-group">
            <label class="col-sm-4 control-label">相关业态</label>

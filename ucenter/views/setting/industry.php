...
$this->title = '参数设置 - 行业';
ucenter\assets\AppAsset::addJsFile($this,'js/main/setting/industry.js');
?>
<div style="margin-bottom: 10px;">
    <?=Html::a('新增行业','script:void(0)',['data-toggle'=>"modal",'data-target'=>"#createModal",'class'=>'btn btn-success','disabled'=>true])?>
</div>
<section class="panel">
        ...
        <table class="table table-bordered table-striped">
            ...
            <?php foreach($list as $l):?>
                <tr>
                    ...
                    <td><?=$l->alias?></td>
                    <td>
                        <?php $relations = $l->companyRelations;?>
